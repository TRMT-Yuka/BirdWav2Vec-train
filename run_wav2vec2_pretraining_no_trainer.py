...
class DataCollatorForWav2Vec2Pretraining:
    ...
    def __call__(self, features: List[Dict[str, Union[List[int], torch.Tensor]]]) -> Dict[str, torch.Tensor]:
        ...
        self.model.config.mask_time_length=5
        ...
        #print(">>",self.model.config.num_negatives)
...
def main():
    ...
    args = parse_args()
    writer = SummaryWriter(log_dir="./logs")# added by trmt on 24/06/17
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if (step + 1) % (args.gradient_accumulation_steps * args.logging_steps) == 0:
                ...
                writer.add_scalar("Training Loss", loss.item(), completed_steps) # added by trmt on 24/06/17
        ...
        if True:
            ...
            writer.add_scalar("Validation Loss", val_logs["val_loss"], completed_steps)# added by trmt on 24/06/17
